        ...
        for neurons in [20, 50, 100, 200, 500]:
            for reg_scale in [0.1, 0.5, 1, 2, 4, 8, 16]:
                for comp_ind in comp_ind_list:
                    ...
                    flags.model_name = flags.data_set + '_every_' + str(flags.average) + '_ind_' + str(flags.comp_ind) + '_complexity_{}x{}_lr_{}_decay_{}_reg_{}_bs_{}'.format(flags.linear[1], len(flags.linear) - 2, flags.lr, flags.lr_decay_rate, flags.reg_scale, flags.batch_size)
